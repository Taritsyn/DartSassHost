   ...
   --------------------------------------------------------------------------------
               README file for Dart Sass Host for .NET v1.0.0 Preview 7
   ...
   1.46.0 with the ability to support a virtual file system.
   ...
   RELEASE NOTES
   =============
   1. Added support of the Dart Sass version 1.46.0;
